...
// app.js guarda essas referências dentro do DOMContentLoaded dele,
...
function abrirMontagem(marcaId, indiceFamilia) {
...
// liga os cliques dentro do modal
document.addEventListener('DOMContentLoaded', () => {
  const mc = document.getElementById('modal-content');
  if (!mc) return;
  mc.addEventListener('click', e => {
    const bMont = e.target.closest('[data-montar]');
